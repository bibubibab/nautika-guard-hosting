        ...
        <div className="flex h-screen"> {/* Set height to full screen */}
            ...
            <div className={`h-full bg-white transition-all duration-300 ${isOpen ? 'w-64' : 'w-18'}`}>
                ...
                <nav className="mt-4 flex flex-col items-center w-full">
                    ...
                    <button onClick={() => navigateTo('Donasi')} className={`flex items-center text-lg px-8 py-5 w-full hover:bg-gray-200 ${activePage === 'Donasi' && 'bg-blue-100'}`}>
                        <img src="/images/donasi.svg" alt="Donasi" className="w-6 h-6" />
                        {isOpen && <span className="ml-4 text-gray-700 font-semibold">Donasi</span>}
                    </button>
                    <button aria-label="Report isu" onClick={() => navigateTo('Report isu')} className={`flex items-center text-lg px-8 py-5 w-full hover:bg-gray-200 ${activePage === 'Report_isu' && 'bg-blue-100'}`}>
            ...
            <div className="flex flex-col flex-1">
                ...
                <div className="flex-1 p-4">
                    ...
                    {activePage === 'Event' && <div><Newevent /></div>}
